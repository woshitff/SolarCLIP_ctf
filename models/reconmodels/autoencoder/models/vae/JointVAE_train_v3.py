...
class multi_model(pl.LightningModule):
    ...
    def __init__(self, config:OmegaConf):
        ...
        self.data_id_to_modal = self.config.data.params.train.modal_list
        assert self.data_modal_list == self.config.data.params.val.modal_list, "train and val modal list should be the same"
