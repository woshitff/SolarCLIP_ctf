...
from models.reconmodels.ldm.util import log_txt_as_img, exists, default, ismap, isimage, mean_flat, count_params, instantiate_from_config
from models.reconmodels.ldm.modules.ema import LitEma
from models.reconmodels.ldm.models.autoencoder import CNN_VAE, IdentityFirstStage
from models.reconmodels.ldm.modules.distributions.distributions import normal_kl, DiagonalGaussianDistribution
from models.reconmodels.ldm.modules.diffusionmodules.util import make_beta_schedule, extract_into_tensor, noise_like
from models.reconmodels.ldm.models.diffusion.ddim import DDIMSampler
...
class DDPM(pl.LightningModule):
    ...
    def p_losses(self, x_start, t, noise=None):
        ...
        loss_dict.update({f'{log_prefix}/z.mean': x_start.mean().item()})
        loss_dict.update({f'{log_prefix}/z.std': x_start.std().item()})
        print(f'loss: {loss}')
...
class LatentDiffusion(DDPM):
    ...
    def __init__(self,
                 ...
                 concat_mode=True,
                 cond_stage_forward=None, # TOCHECK: what's this for?
                 conditioning_key=None, # 'crossattn' TOCHECK: what's the difference between this and cond_stage_key?
                 scale_factor=1.0,
                 scale_by_std=False,
    ...
    def _get_denoise_row_from_list(self, samples, desc='', force_no_decoder_quantization=False):
        ...
        denoise_row = torch.stack(denoise_row)  # n_log_step, n_row, C, H, W， n_row is like batch_size
