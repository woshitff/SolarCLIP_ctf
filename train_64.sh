...
python train_scripts/train.py --b '/mnt/tianwen-tianqing-nas/tianwen/ctf/solarclip/zyz_106/configs/train_configs/reconmodels/ldm/mainconfig/zyz/zyz_64.yaml'