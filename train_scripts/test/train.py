...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        ...
        default=['configs/train_configs/reconmodels/ldm/mainconfig/hmi2aia0094/clip_condition/hmi_cliptoken_2_aia0094_cliptoken_crossattn_withdecoder_1x128x128_ldm_openaimodel.yaml']
    )
    parser.add_argument(
        "-f",
        "--postfix",
