...
python train_scripts/train.py --b /mnt/tianwen-tianqing-nas/tianwen/ctf/solarclip/zyz_106/configs/train_configs/reconmodels/autoencoder/ae_zyz/ae0193_first.yaml
python train_scripts/train.py --b /mnt/tianwen-tianqing-nas/tianwen/ctf/solarclip/zyz_106/configs/train_configs/reconmodels/autoencoder/ae_zyz/ae0193_second.yaml
