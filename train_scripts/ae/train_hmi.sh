...
python train_scripts/train.py --b /mnt/tianwen-tianqing-nas/tianwen/ctf/solarclip/zyz_106/configs/train_configs/reconmodels/autoencoder/ae_zyz/aehmi_first.yaml
python train_scripts/train.py --b /mnt/tianwen-tianqing-nas/tianwen/ctf/solarclip/zyz_106/configs/train_configs/reconmodels/autoencoder/ae_zyz/aehmi_second.yaml
